...
public record IntegrationResourceResponse(
        ...
        @Schema(description = "리소스 종류", example = "FIGMA_FILE")
        IntegrationResourceType resourceType,
        @Schema(description = "표시용 리소스 이름", example = "Plog 디자인")
        String resourceName,
        @Schema(description = "원본 provider URL")
        String resourceUrl,
        @Schema(description = "리소스 접근 상태", example = "ACTIVE")
        ...
        @Schema(description = "마지막 수집 시각. 아직 수집 전이면 null")
