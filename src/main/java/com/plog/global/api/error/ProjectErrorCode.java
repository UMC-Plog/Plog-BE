...
public enum ProjectErrorCode implements BaseErrorCode {
    ...
    INVALID_PROJECT_END_DAY(HttpStatus.BAD_REQUEST, "PROJECT005", "예상 종료일은 오늘 또는 그 이후여야 합니다."),
    ...
    ACTOR_MAPPING_REQUIRED(HttpStatus.BAD_REQUEST, "PROJECT012", "연동된 외부 서비스의 계정 선택을 모두 완료해야 프로젝트를 제출할 수 있습니다."),
